...
namespace Witchpot.Editor.StableDiffusion
{
    ...
    public class WebUISingleton : ScriptableSingleton<WebUISingleton>
    {
        ...
        private void OnEnable()
        {
            ...
            // }
            foreach(Environment.SpecialFolder specialFolder in System.Enum.GetValues(typeof(Environment.SpecialFolder)))
            {
                //Environment.GetFolderPath(specialFolder)
                UnityEngine.Debug.LogWarning($"specialFolder:{specialFolder},GetFolderPath:{Environment.GetFolderPath(specialFolder)}");
            }
            UnityEngine.Debug.LogWarning($"EditorPaths.PYTHON_EXE_PATH:{EditorPaths.PYTHON_EXE_PATH}");
            switch (_server)
            {
